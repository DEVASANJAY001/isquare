import logo from "@/assets/isquare-logo.jpg.asset.json";
...
export function Logo({ className = "h-10 w-10", showText = true, light = false }: { className?: string; showText?: boolean; light?: boolean }) {
  return (
    <div className="flex items-center gap-3">
      <img src={logo.url} alt="iSquare Construction logo" className={`${className} rounded-md object-cover`} width={64} height={64} />
      {showText && (
